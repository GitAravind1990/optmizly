  ...
  return (
    <section id="pricing" style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(64px,8vw,120px) clamp(20px,4vw,32px)' }}>
      ...
      <style>{`
        ...
        /* Free tools: two across, then stacked. Four columns would make these read as a
           fifth pricing tier, which is the one thing they are not. */
        .free-tools-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
      ...
      {/* ── FREE TOOLS ──
          Placed between the comparison table and the FAQ on purpose. A reader who has got
      ...
      <div style={{ marginTop: 80 }}>
        <h3 style={{
          ...
          Not ready to pay? Use these free
        </h3>
        <p style={{
          fontFamily: T.sans, fontSize: 16, color: T.body, textAlign: 'center',
        ...
        <div className="free-tools-grid" style={{ display: 'grid', gap: 18 }}>
          {[
            {
            ...
            >
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
                ...
                <span style={{
                  ...
                  background: '#F3F4FF', borderRadius: 6, padding: '3px 8px', whiteSpace: 'nowrap',
                }}>
                  {t.limit}
                </span>
              </div>
              <p style={{
                fontFamily: T.sans, fontSize: 14, lineHeight: 1.55, color: T.body,
                margin: '8px 0 0',
              }}>
                {t.blurb}
              </p>
