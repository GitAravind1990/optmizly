    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="grid grid-cols-4 gap-3 mb-4">
        {[
          ...
          { label: 'Domain Score', value: analysis.domainAuthority.toString(), bg: 'bg-blue-50', text: 'text-blue-600', real: !!quality.authority },
          ...
          <div key={m.label} className={`${m.bg} rounded-lg p-3 text-center`} title={m.label.startsWith('Domain Score') ? "A domain-rank score from live backlink data, a different metric and scale than Moz's Domain Authority" : undefined}>
