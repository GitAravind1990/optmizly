...
const sections = [
  ...
  },
  {
    ...
    body: `We share data with the following sub-processors to operate the Service: Clerk (authentication and user management), Supabase/PostgreSQL (database), DoDo Payments (payment processing), Anthropic (AI analysis – content you submit is processed under Anthropic's API terms), Resend (transactional email), Vercel (hosting and edge functions), PostHog (product analytics and error monitoring), DataForSEO and OpenPageRank (keyword, ranking, backlink and domain metrics – we send the keywords, domains and URLs you analyse), and Google (Search Console, PageSpeed Insights and Maps/Places APIs, used to retrieve performance and location data for the sites you analyse or connect). Each service operates under its own privacy policy and data processing agreements. Please review Anthropic's privacy policy at anthropic.com.`,
  },
  {
