      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="flex items-center gap-3 mb-10 pb-10 border-b border-slate-100">
          ...
          <div className="flex items-center gap-3">
            {/* TODO: add your Twitter/X URL */}
            <a href="#" className="text-slate-400 hover:text-slate-700 transition-colors" aria-label="Twitter / X">
            ...
            <a href="#" className="text-slate-400 hover:text-slate-700 transition-colors" aria-label="LinkedIn">
