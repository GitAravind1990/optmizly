  ...
  },
  {
    ...
    subCategories: [
      sub('Experience', [
        ...
        ['No case studies or real results'],
        ['No author bio with credentials'],
      ], 'eeat', 0),
      sub('Expertise', [
        ['No author bylines on expert content'],
      ...
      sub('Trustworthiness', [
        ['No disclaimer on sensitive (medical/financial/legal) content'],
  ...
  },
  {
    ...
    subCategories: [
      ...
      sub('Citation Readiness', [
        ...
        ["No 'last reviewed' dates on content"],
        ['No structured definitions for key concepts'],
