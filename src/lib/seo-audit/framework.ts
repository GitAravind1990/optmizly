...
export const AUDIT_FRAMEWORK: AuditCategory[] = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      sub('Missing Schemas', [
        ...
        ['MedicalClinic / Hospital (medical sites)', true],
        ['Person (authors/experts as entities)', true],
        ['BreadcrumbList', true],
        ['FAQPage', true],
        ['Article / BlogPosting', true],
  ...
  },
  {
    ...
    subCategories: [
      sub('Pages to Deindex', [
        ['WordPress tag archive pages', true],
        ['Author archive pages', true],
        ['Attachment/media pages (WordPress)'],
        ['Internal search result pages', true],
        ['Filter/facet URL combinations'],
        ['Paginated pages beyond page 2-3 (blog archives)', true],
        ['Staging or dev site pages indexed'],
        ['Parameter URL duplicates', true],
  ...
  },
  {
    ...
    subCategories: [
      ...
      sub('WP Technical', [
        ...
        ['Default WordPress URLs (?p=123) still accessible', true],
        ['xmlrpc.php accessible (security + crawl issue)', true],
        ['readme.html leaking WordPress version', true],
      ], 'wordpress', 2),
    ],
  },
  {
  ...
  },
  {
    ...
    subCategories: [
      sub('Experience', [
        ['No first-hand experience signals in content', true],
        ['No case studies or real results', true],
        ['No author bio with credentials', true],
      ], 'eeat', 0),
      sub('Expertise', [
        ['No author bylines on expert content', true],
        ['Author not linked to credentials or qualification page'],
        ['Content not reviewed by a qualified professional', true],
      ], 'eeat', 1),
      sub('Authoritativeness', [
        ['No mentions or citations from authoritative sources'],
        ['No backlinks from trusted industry sources'],
        ['No Wikipedia entity or Knowledge Panel'],
        ['Missing Organization entity in schema', true],
      ], 'eeat', 2),
      sub('Trustworthiness', [
        ['No disclaimer on sensitive (medical/financial/legal) content', true],
        ['No privacy policy or terms of service', true],
        ['No clear contact information', true],
  ...
  },
  {
    ...
    subCategories: [
      sub('Entity Gaps', [
        ['Authors/experts not marked as Person entities in schema', true],
        ['Products/services not connected to related entities'],
        ['Organization entity missing from About page'],
        ['Brand not in Google Knowledge Graph'],
        ['No Wikidata or Wikipedia entity'],
      ], 'aiSeo', 0),
      sub('GEO Readiness', [
        ['No FAQ content on key pages', true],
        ['No statistics or research citations in content', true],
        ['No expert quotes or attributable statements', true],
        ['Content not structured for direct answer extraction', true],
      ...
      sub('Topical Authority', [
        ...
        ['No co-citation with authoritative sources'],
      ], 'aiSeo', 2),
      sub('Citation Readiness', [
        ['No unique data points or research', true],
        ["No 'last reviewed' dates on content", true],
        ['No structured definitions for key concepts', true],
        ['Content too short to be citeable source', true],
      ], 'aiSeo', 3),
    ],
  },
  {
