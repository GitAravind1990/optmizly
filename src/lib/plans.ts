...
export const PLAN_TOOLS: Record<Plan, string[]> = {
  ...
  AGENCY: ['analyse', 'onpage', 'optimizer', 'eeat', 'backlinks', 'citation', 'gap', 'queries', 'rewrite', 'serp', 'topical', 'local', 'tracker', 'content-ideas', 'competitor-spy', 'rank-tracker', 'local-seo', 'seo-audit'],
}
